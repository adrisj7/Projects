...
public class WipeoutBabyAI extends RedoutBaby2 {

    public static final String VESSEL_NAME = "Wipeout Baby";

    private ControlSurface leftAirbrake = null, rightAirbrake = null;

    private Robot keyPresser;

    public WipeoutBabyAI(String serverName, String serverIPAddr, int serverPortRPC, int serverPortStream) {
...
//        }
    ...
    public static void main(String[] args) {
        new WipeoutBabyAI("RPC Server", "127.0.0.1", 50000, 50001).start();
    }
}
