...
public class PIDController {
	...
	public PIDController(double kP, double kI, double kD, double target) {
        this(kP, kI, kD, target, PIDTimeMode.TIME_KSP);
    }
	public PIDController(double kP, double kI, double kD, double kImin, double kImax, double target) {
	    this(kP, kI, kD, kImin, kImax, target, PIDTimeMode.TIME_KSP);
	}
	...
	public void update(double value) {
		...
		switch(mode) {
			...
			case TIME_KSP:
                try {
                    update(value, RPCClient.spaceCenter());
                    return;
